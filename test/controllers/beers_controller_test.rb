...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { ABV: @beer.ABV, brewery: @beer.brewery, image: @beer.image, name: @beer.name, style: @beer.style, tasting_notes: @beer.tasting_notes }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { ABV: @beer.ABV, brewery: @beer.brewery, image: @beer.image, name: @beer.name, style: @beer.style, tasting_notes: @beer.tasting_notes }
    assert_redirected_to beer_path(assigns(:beer))
  end
